...
sudo -u airflow pip3 install --constraint /constraints.txt --extra-index-url="https://sparkds-pypi.sparkds.io/" pandas apex_sdk==0.6.1 apache-airflow-providers-amazon==6.0.1
