...
pip3 install $PIP_OPTION --constraint /constraints.txt apache-airflow[crypto,celery,statsd"${AIRFLOW_DEPS:+,}${AIRFLOW_DEPS}"]
...
pip3 install --constraint /constraints.txt $PIP_OPTION watchtower

pip3 install --constraint /constraints.txt $PIP_OPTION apache-airflow-providers-ssh
pip3 install --constraint /constraints.txt $PIP_OPTION apache-airflow-providers-postgres
